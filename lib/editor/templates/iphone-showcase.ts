...
const iphoneShowcase: Template = {
  ...templateMeta["iphone-showcase"],
  state: {
    schemaVersion: 1,
    present: {
      activeTool: "pointer",
      ...
      canvases: [
        {
          ...
          background: {
            type: "auto",
            value: "linear-gradient(270deg, #2d2c2d, #8b8a91)",
          },
          padding: 40,
          borderRadius: 7,
          ...
          overlay: { id: 1, opacity: 50, position: "overlay" },
          frame: {
            id: "iphone_17_pro",
            color: "silver",
